...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier ici des messages de validation personnalisés pour les
    | attributs en utilisant la convention "attribute.rule" pour nommer les lignes.
    | Cela permet de spécifier rapidement une ligne de message personnalisée pour
    ...
    */
    ...
    | réservé d'attribut avec quelque chose de plus lisible, comme "Adresse E-Mail"
    | au lieu de "email". Cela nous aide simplement à rendre notre message plus
    | expressif.
    |
    */
